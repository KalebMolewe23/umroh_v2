...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <span class="text"><i class='bx bxs-briefcase'></i> Tambah Agen</span>
        </div>

        <main>
            <div class="container-fluid">
                <form action="/agen/saveAgen" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input class="travel_input_3" name="name_agen" type="text" placeholder="Masukkan Nama Lengkap" required>
                        </div>
                        <div class="col">
                            <strong>Nomor HP</strong>
                            <input class="travel_input_3" name="phone_agen" type="number" placeholder="Masukkan Nomor Hp" required>
                        </div>
                        <div class="col">
                        </div>
                    </div><br>
                    <strong>Email</strong>
                    <input class="travel_input_3" name="email_agen" type="text" placeholder="iniemail@email.com" required>
                    <br><strong>Kota</strong>
                    <select class="ticket_option" name="id_regencies" required>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="ticket_option" name="bank" required>
                    ...
                    <div class="col">
                        ...
                        <input class="travel_input_3" name="number_rek" type="number" placeholder="Masukkan Nomor Rekening" required>
                    </div>
                    <div class="col">
                    </div>
                    </div><br>
