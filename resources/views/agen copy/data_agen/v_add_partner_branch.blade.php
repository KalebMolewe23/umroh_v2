...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <span class="text"><i class='bx bxs-briefcase'></i> Tambah Cabang</span>
        </div>

        <main>
            <div class="container-fluid">
                <form action="/agen/savePartner_branch" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col">
                        ...
                        <input class="travel_input_3" name="cost" type="number" placeholder="Masukkan Biaya Transportasi & Akomodasi Lokal" required>
                    </div>
                    <div class="col">
                    </div>
                    </div><br>
