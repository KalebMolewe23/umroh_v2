...
<body>
    ...
    <section class="home-section">
        ...
        <div class="home-content">
            ...
            <span class="text"><i class='bx bxs-briefcase'></i> Data Agen</span>
        </div>

        <main>
            <div class="container-fluid"><br>
            <?php
                $data_user = DB::table('agens')->where('id_user', $id)->get();
            ...
            <?php }else{ ?>
                <table class="table table-striped" id="ajax-crud-datatable-agen">
                    <thead>
                        <tr>
