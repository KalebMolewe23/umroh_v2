        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="card"><br>
                    ...
                    <form action="/agen/proses_save_packet" method="post" enctype="multipart/form-data" id="input_ticket">
                        @csrf
                        <input type="hidden" name="id_user" value="<?= $id; ?>"><br>
                        <strong>Informasi Paket</strong><br><br>
                        <strong>Nama Paket</strong><br>
                        <input class="travel_input_2" maxlength="50" name="name_packet" type="text" placeholder="Masukkan Nama Paket" required><br><br>
                        <strong>Tiket Group</strong><br>
                        Jadwal, kota, maskapai serta kapasitas seat disesuaikan dengan Tiket Group. Untuk menambahkan Tiket Group <a href="/agen/add_ticket_group">Silahkan Klik Disini</a><br>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="travel_input" name="maskapai_name" type="text" placeholder="Maskapai Penerbangan" id="penerbangan" required readonly>
                            </div>
                            <div class="col">
                                <strong>Kota Keberangkatan</strong><br>
                                <input class="travel_input" name="departure_city" type="hidden" placeholder="Kota Keberangkatan" id="kota_save" required>
                                <input class="travel_input" type="text" placeholder="Kota Keberangkatan" id="kota" required readonly>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                <strong>Jadwal Keberangkatan</strong><br>
                                <input class="travel_input" name="departure_date" type="text" placeholder="Jadwal Keberangkatan" id="jadwal" required readonly>
                            </div>
                            <div class="col">
                                <strong>Kapasitas Seat</strong><br>
                                <input class="travel_input" name="seat_capasitas" type="text" placeholder="Kapasitas Seat" id="seat" required readonly>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input class="travel_input" name="dp" type="text" placeholder="Uang Muka" id="dp" required>
                            </div>
                        </div><br>
                        <div align="right">
