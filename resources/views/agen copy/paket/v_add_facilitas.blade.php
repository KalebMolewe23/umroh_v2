        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="card"><br>
                    ...
                    <form action="/agen/proses_save_facilitas" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_user" value="<?= $id; ?>">
                        <input type="hidden" name="id_money" value="<?= $id_product->id; ?>">
                        <input type="hidden" name="id_hotel" value="<?= $id_product->id_hotel; ?>">
                        <input type="hidden" name="id_packet" value="<?= $id_product->id_packet; ?>"><br>
                        <strong>Informasi Fasilitas</strong><br><br>
                        <strong>Yang Termasuk</strong><br>
                        <input class="travel_input" name="in_facilitas" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas" required><br><br>
                        ...
                        <div id="facilitas_in">
                            <input class="travel_input" name="in_facilitas_1" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_1"><br><br>
                        ...
                        <div id="facilitas_in_2">
                            <input class="travel_input" name="in_facilitas_2" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_2"><br><br>
                        ...
                        <div id="facilitas_in_3">
                            <input class="travel_input" name="in_facilitas_3" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_3"><br><br>
                        ...
                        <div id="facilitas_in_4">
                            <input class="travel_input" name="in_facilitas_4" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_4"><br><br>
                        ...
                        <div id="facilitas_in_5">
                            <input class="travel_input" name="in_facilitas_5" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_5"><br><br>
                        ...
                        <div id="facilitas_in_6">
                            <input class="travel_input" name="in_facilitas_6" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_6"><br><br>
                        ...
                        <div id="facilitas_in_7">
                            <input class="travel_input" name="in_facilitas_7" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_7"><br><br>
                        ...
                        <div id="facilitas_in_8">
                            <input class="travel_input" name="in_facilitas_8" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_8"><br><br>
                        ...
                        <div id="facilitas_in_9">
                            <input class="travel_input" name="in_facilitas_9" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="in_facilitas_9"><br><br>
                        </div>

                        <br><br><strong>Yang Tidak Termasuk</strong><br>    
                        <input class="travel_input" name="out_facilitas" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas" required><br><br>
                        ...
                        <div id="facilitas_out">
                            <input class="travel_input" name="out_facilitas_1" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_1"><br><br>
                        ...
                        <div id="facilitas_out_2">
                            <input class="travel_input" name="out_facilitas_2" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_2"><br><br>
                        ...
                        <div id="facilitas_out_3">
                            <input class="travel_input" name="out_facilitas_3" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_3"><br><br>
                        ...
                        <div id="facilitas_out_4">
                            <input class="travel_input" name="out_facilitas_4" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_4"><br><br>
                        ...
                        <div id="facilitas_out_5">
                            <input class="travel_input" name="out_facilitas_5" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_5"><br><br>
                        ...
                        <div id="facilitas_out_6">
                            <input class="travel_input" name="out_facilitas_6" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_6"><br><br>
                        ...
                        <div id="facilitas_out_7">
                            <input class="travel_input" name="out_facilitas_7" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_7"><br><br>
                        ...
                        <div id="facilitas_out_8">
                            <input class="travel_input" name="out_facilitas_8" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_8"><br><br>
                        ...
                        <div id="facilitas_out_9">
                            <input class="travel_input" name="out_facilitas_9" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" id="out_facilitas_9"><br><br>
                        </div>
                <br><br></div><br>
                <div align="right">
