        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="card"><br>
                    <div class="row">
                        <div class="col">
                            1. <i class='bx bxs-info-circle' ></i> Informasi Paket
                        </div>
                        <div class="col">
                            2. <i class='bx bxs-buildings'></i> Hotel
                        </div>
                        <div class="col">
                            3. <i class='bx bx-money' ></i> Harga
                        </div>
                        <div class="col">
                            4. <i class='bx bxs-hand-up'></i> Fasilitas
                        </div>
                        <div class="col">
                            5. <i class='bx bx-list-check'></i> Syarat & Ketentuan
                        </div>
                        <div class="col">
                            6. <i class='bx bxs-camera-movie'></i> Foto & Video
                        </div>
                    </div><br>
                    <form action="/agen/proses_save_condition" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_user" value="<?= $id; ?>">
                        <input type="hidden" name="id_facilitas" value="<?= $id_product->id; ?>">
                        <input type="hidden" name="id_money" value="<?= $id_product->id_money; ?>">
                        <input type="hidden" name="id_packet" value="<?= $id_product->id_packet; ?>">
                        <input type="hidden" name="id_hotel" value="<?= $id_product->id_hotel; ?>"><br>
                        <strong>Informasi Syarat & Ketentuan</strong><br><br>
                        <input class="travel_input" name="in_condition" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition" required><br><br>
                        ...
                        <div id="condition">
                            <input class="travel_input" name="in_condition_1" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_1"><br><br>
                        ...
                        <div id="condition_2">
                            <input class="travel_input" name="in_condition_2" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_2"><br><br>
                        ...
                        <div id="condition_3">
                            <input class="travel_input" name="in_condition_3" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_3"><br><br>
                        ...
                        <div id="condition_4">
                            <input class="travel_input" name="in_condition_4" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_4"><br><br>
                        ...
                        <div id="condition_5">
                            <input class="travel_input" name="in_condition_5" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_5"><br><br>
                        ...
                        <div id="condition_6">
                            <input class="travel_input" name="in_condition_6" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_6"><br><br>
                        ...
                        <div id="condition_7">
                            <input class="travel_input" name="in_condition_7" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_7"><br><br>
                        ...
                        <div id="condition_8">
                            <input class="travel_input" name="in_condition_8" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_8"><br><br>
                        ...
                        <div id="condition_9">
                            <input class="travel_input" name="in_condition_9" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_9"><br><br>
                        ...
                        <div id="condition_10">
                            <input class="travel_input" name="in_condition_10" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_10"><br><br>
                        ...
                        <div id="condition_11">
                            <input class="travel_input" name="in_condition_11" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_11"><br><br>
                        ...
                        <div id="condition_12">
                            <input class="travel_input" name="in_condition_12" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_12"><br><br>
                        ...
                        <div id="condition_13">
                            <input class="travel_input" name="in_condition_13" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_13"><br><br>
                        ...
                        <div id="condition_14">
                            <input class="travel_input" name="in_condition_14" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_14"><br><br>
                        ...
                        <div id="condition_15">
                            <input class="travel_input" name="in_condition_15" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_15"><br><br>
                        ...
                        <div id="condition_16">
                            <input class="travel_input" name="in_condition_16" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_16"><br><br>
                        ...
                        <div id="condition_17">
                            <input class="travel_input" name="in_condition_17" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_17"><br><br>
                        ...
                        <div id="condition_18">
                            <input class="travel_input" name="in_condition_18" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_18"><br><br>
                        ...
                        <div id="condition_19">
                            <input class="travel_input" name="in_condition_19" type="text" maxlength="255" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_19"><br><br>
                        </div><br><br>
                </div><br>
                <div align="right">
