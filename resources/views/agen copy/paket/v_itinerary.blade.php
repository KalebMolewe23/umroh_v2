...
<body>
    ...
    <section class="home-section">
      ...
      <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-plane'></i> Data Itinerary</span>
      </div>
        ...
        <div class="container-fluid"><br>
            ...
            <div class="card"><br>
                ...
                <center>
                    ...
                    <a href="/agen/add_itinerary"><button class="btn btn-primary"><i class='bx bx-plus'></i> Tambah Jadwal</button></a>
                </center><br>

                <?php }else{ ?>
                <table class="table table-striped" id="ajax-data-itinerary">
                    <thead>
                        <tr>
