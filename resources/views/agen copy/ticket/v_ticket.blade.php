...
<body>
    ...
    <section class="home-section">
      ...
      <div class="home-content">
        ...
        <span class="text"><i class='bx bxs-plane'></i> Data Tiket Group</span>
      </div>
      ...
      <main>
        <div class="container-fluid"><br>
            <br>
            <div class="card"><br>
            <form action="{{ url('/agen/data_ticket_group') }}" method="get">
                <div class="row">
                        <div class="col">
                            <select class="ticket_option_2" name="maskapai" required>
                                <option value="">Pilih Maskapai</option>
                                <?php foreach($maskapai as $v_maskapai){ ?>
                                    <option value="<?= $v_maskapai->id ?>"><?= $v_maskapai->name_maskapai; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col">
                            <select class="ticket_option_2" name="id_maskapai" required>
                        ...
                        <div class="col">
                            <select class="ticket_option_2" name="maskapai" required>
                                <option value="">Pilih Harga Tiket Per-Pax</option>
                                
                            </select>
                        </div>
                        <div class="col">
                            <select class="ticket_option_2" name="maskapai" required>
                                <option value="">Pilih Urutkan Harga</option>
                                <option value="1">Murah</option>
                                <option value="2">Mahal</option>
                            </select>
                            <button type="submit" class="btn btn-primary button_filter">Filter</button>
                        </div>
                    </div>
                </form>
                <br><br>

                <!-- kondisi saat tiket group sudah dibuat maupun belum dibuat -->

                <?php
                    $data_user = DB::table('ticket_groups')->where('id_user', $id)->get();
