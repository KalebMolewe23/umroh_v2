            ...
            <br><div class="card"><br>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="travel_input_3" maxlength="6" name="maskapai_code" type="text" placeholder="XYZAB" required>
                        </div>
                        <div class="col">
                            <strong>Kapasitas Seat</strong><br>
                            <input class="travel_input_3" name="seat_capasitas" type="number" placeholder="Pax" required>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input class="travel_input_3" name="price_ticket" type="text" id="price_ticket" placeholder="Contoh: 12.000.000" required>
                        </div>
                        <div class="col">
                        </div>
                    </div><br><br>
                    ...
                    <input class="travel_input_3" maxlength="6" name="departure_flight_code" type="text" placeholder="WY 50" required><br>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input class="travel_input_3" name="departure_date" type="date" placeholder="Waktu Keberangkatan" required>
                        </div>
                        <div class="col">
                            <strong>Jam Keberangkatan</strong><br>
                            <input class="travel_input_3" name="departure_time" type="time" placeholder="Local Time" required>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input class="travel_input_3" name="departure_date_arrival" type="date" placeholder="Waktu Keberangkatan" required>
                        </div>
                        <div class="col">
                            <strong>Jam Kedatangan 0</strong><br>
                            <input class="travel_input_3" name="departure_time_arrival" type="time" placeholder="Local Time" required>
                        </div>
                    </div><br>
                    <div id="transit_departure">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="travel_input_3" name="departure_date_transit" type="date" placeholder="Waktu Transit" >
                            </div>
                            <div class="col">
                                <strong>Jam Kedatangan Transit 0</strong><br>
                                <input class="travel_input_3" name="departure_time_transit" type="time" placeholder="Local Time" >
                            </div>
                        </div><br>
                    </div>
                    ...
                    <strong>Kode Penerbangan</strong>
                    <input class="travel_input_3" maxlength="6" name="homecoming_flight_code" type="text" placeholder="WY 50" required><br>
                    <div class="row">
                        <div class="col">
                            <strong>Kota Keberangkatan</strong><br>
                            <select class="ticket_option" name="id_homecoming_city" required>
                                <option value=""> -Silahkan Pilih Kota Keberangkatan- </option>
                        ...
                        <div class="col">
                            <strong>Tanggal Keberangkatan</strong><br>
                            <input class="travel_input_3" name="homecoming_date" type="date" placeholder="Waktu Keberangkatan" required>
                        </div>
                        <div class="col">
                            <strong>Jam Keberangkatan</strong><br>
                            <input class="travel_input_3" name="homecoming_time" type="time" placeholder="Local Time" required>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col">
                            <strong>Kota Kedatangan</strong><br>
                            <select class="ticket_option" name="id_homecoming_city_arrival" required>
                                <option value=""> -Silahkan Pilih Kota Kedatangan- </option>
                        ...
                        <div class="col">
                            <strong>Tanggal Kedatangan</strong><br>
                            <input class="travel_input_3" name="homecoming_date_arrival" type="date" placeholder="Waktu Keberangkatan" required>
                        </div>
                        <div class="col">
                            <strong>Jam Kedatangan 0</strong><br>
                            <input class="travel_input_3" name="homecoming_time_arrival" type="time" placeholder="Local Time" required>
                        </div>
                    </div><br>
                    <div id="transit_homecoming">
                        <div class="row">
                            <div class="col">
                                <strong>Kota Kedatangan Transit</strong><br>
                                <select class="ticket_option" name="id_homecoming_city_transit" required>
                            ...
                            <div class="col">
                                <strong>Tanggal Kedatangan Transit</strong><br>
                                <input class="travel_input_3" name="homecoming_date_transit" type="date" placeholder="Waktu Transit" >
                            </div>
                            <div class="col">
                                <strong>Jam Kedatangan Transit 0</strong><br>
                                <input class="travel_input_3" name="homecoming_time_transit" type="time" placeholder="Local Time" >
                            </div>
                        </div><br>
                    </div>
