    ...
    <section class="home-section">
      ...
      <main>
        ...
        <br>
            ...
            <div align="left">
                <a href="money"><button type="submit" class="btn btn-default"><i class='bx bx-arrow-back'></i> Sebelumnya</button></a>
            </div><br>
                <div class="card"><br>
                <center>
                    <img src="{{ asset('/assets/img/verif.png') }}" width="100px"><br>
                    <strong>Terima Kasih</strong>
                    <p>Data anda akan kami verifikasi dalam waktu 1x24 jam Anda akan segera kami hubungin kembali</p>
                    <p>setelah selesai diverifikasi</p>
                </center>
                </div>
