...
?>
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="content-wrapper">
            ...
            <form action="{{ url('/admin/proccess_update_ticket_bursa/'.$ticket_packet->id) }}" method="post" enctype="multipart/form-data" id="input_ticket">
            <div class="card">
                @csrf
                <input type="hidden" name="id" value="<?= $ticket_packet->id; ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
                                ...
                                <select class="form-control" name="id_maskapai" required>
                                    <?php $maskapai_keberangkatan = DB::table('bursa_tickets')->join('maskapais','maskapais.id','=','bursa_tickets.id_maskapai')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                    <?php foreach($maskapai_keberangkatan as $v_maskapai_keberangkatan){ ?>
                                        <option value="<?= $v_maskapai_keberangkatan->id_maskapai ?>"><?= $v_maskapai_keberangkatan->name_maskapai ?></option>
                                    <?php } ?>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
                                ...
                                <?php $maskapai_kepulangan = DB::table('bursa_tickets')->join('maskapais','maskapais.id','=','bursa_tickets.id_maskapai_homecoming')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                    <?php foreach($maskapai_kepulangan as $v_maskapai_kepulangan){ ?>
                                        <option value="<?= $v_maskapai_kepulangan->id_maskapai_homecoming ?>"><?= $v_maskapai_kepulangan->name_maskapai ?></option>
                                    <?php } ?>
                                    @foreach($tiket as $v_tiket)
                                        <option value="<?= $v_tiket->id ?>"><?= $v_tiket->name_maskapai ?></option>
                                    @endforeach
                        ...
                        <div class="row">
                            <div class="col">
                                <h5 class="m-0 me-2">Tipe Tiket</h5>
                                <select class="form-control" name="ticket_type">
                                    <?php $ticket_packet_bursa = DB::table('bursa_tickets')->where('bursa_tickets.id', $ticket_packet->id)->get();?>
                                    <?php foreach($ticket_packet_bursa as $v_ticket_packet_bursa){ ?>
                                        <?php if($v_ticket_packet_bursa->ticket_type == 1){ ?>
                                            <option value="1">Group</option>
                                        <?php }else if($v_ticket_packet_bursa->ticket_type == 2){ ?>
                                            <option value="1">Rontokan</option>
                                        <?php } ?>
                                    <?php } ?>
                                    <option value="1">Group</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="id_departure_city">
                                    <?php $kota_keberangkatan_1 = DB::table('bursa_tickets')->join('airports','airports.code','=','bursa_tickets.id_departure_city')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                        <?php foreach($kota_keberangkatan_1 as $v_kota_keberangkatan_1){ ?>
                                            <option value="<?= $v_kota_keberangkatan_1->id_departure_city ?>"><?= $v_kota_keberangkatan_1->cityName; ?> - <?= $v_kota_keberangkatan_1->name ?></option>
                                        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="id_departure_city_arrival">
                                    <?php $kota_keberangkatan_2 = DB::table('bursa_tickets')->join('airports','airports.code','=','bursa_tickets.id_departure_city_arrival')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                        <?php foreach($kota_keberangkatan_2 as $v_kota_keberangkatan_2){ ?>
                                            <option value="<?= $v_kota_keberangkatan_2->id_departure_city_arrival ?>"><?= $v_kota_keberangkatan_2->cityName; ?> - <?= $v_kota_keberangkatan_2->name ?></option>
                                        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="id_homecoming_city" required>
                                    <?php $kota_kepulangan_1 = DB::table('bursa_tickets')->join('airports','airports.code','=','bursa_tickets.id_homecoming_city')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                        <?php foreach($kota_kepulangan_1 as $v_kota_kepulangan_1){ ?>
                                            <option value="<?= $v_kota_kepulangan_1->id_homecoming_city ?>"><?= $v_kota_kepulangan_1->cityName; ?> - <?= $v_kota_kepulangan_1->name ?></option>
                                        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="id_homecoming_city_arrival" required>
                                    <?php $kota_kepulangan_2 = DB::table('bursa_tickets')->join('airports','airports.code','=','bursa_tickets.id_homecoming_city_arrival')->where('bursa_tickets.id', $ticket_packet->id)->get(); ?>
                                        <?php foreach($kota_kepulangan_2 as $v_kota_kepulangan_2){ ?>
                                            <option value="<?= $v_kota_kepulangan_2->id_homecoming_city_arrival ?>"><?= $v_kota_kepulangan_2->cityName; ?> - <?= $v_kota_kepulangan_2->name ?></option>
                                        <?php } ?>
