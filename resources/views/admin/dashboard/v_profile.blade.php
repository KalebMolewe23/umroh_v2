    ...
    <!-- start content -->
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="card">
                    <div class="card-body">
                        @foreach($profile as $v_profile)
                            <form action="{{ url('/admin/proccess_update_profile/'.$v_profile->id) }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <label>Nama</label>
                                        <input type="text" class="form-control" name="name" value="{{ $v_profile->name }}" required>
                                    </div>
                                    <div class="col">
                                        <label>email</label>
                                        <input type="text" class="form-control" value="{{ $v_profile->email }}" name="email" readonly>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col">
                                        <label>No. Telp</label>
                                        <input type="number" class="form-control" name="phone" value="{{ $v_profile->phone }}" required>
                                    </div>
                                    <div class="col">
                                        <label>KTP</label>
                                        <input type="text" class="form-control" value="{{ $v_profile->ktp }}" name="ktp" required>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col">
                                        <label>Tanggal Lahir</label>
                                        <input type="date" class="form-control" name="date_of_birth" value="{{ $v_profile->date_of_birth }}" required>
                                    </div>
                                    <div class="col">
                                        <label>Tempat Lahir</label>
                                        <input type="text" class="form-control" value="{{ $v_profile->born_place }}" name="born_place" required>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col">
                                        <label>Kewarganegaraan</label>
                                        <input type="text" class="form-control" name="citizenship" value="{{ $v_profile->citizenship }}" required>
                                    </div>
                                    <div class="col">
                                        <label>password</label>
                                        <input type="password" class="form-control" value="{{ $v_profile->born_place }}" name="born_place" required>
                                    </div>
                                </div><br>
