    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                <form action="{{ url('/admin/proses_update_bg/'.$bg->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                        <h4>Edit Logo & Background Website</h4><br>
                        <input type="hidden" name="id" value="<?= $bg->id; ?>">
                            <div class="row">
                                <div class="col">
                                    <img src="{{ asset('/assets/img/'.$bg->logo) }}" width="300px">
                                </div>
                                <div class="col">
                                    <p>Ekstensi file yang diperbolehkan: .JPG .JPEG .PNG</p>
                                    <input type="file" name="logo" class="form-control"><br>
                                    <label>Nama Website</label>
                                    <input type="text" class="form-control" name="name_website" value="<?= $bg->name_website ?>">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                    <label>Background Dasar</label>
                                    <input type="color" name="bg1" class="form-control" value="<?= $bg->bg1 ?>">
                                </div>
                                <div class="col">
                                    <label>Background Ke-2</label>
                                    <input type="color" name="bg2" class="form-control" value="<?= $bg->bg2 ?>">
                                </div>
                            </div><br>
                            <h4>Banner Website</h4>
                            <p style="color:red">*Catatan dimensi(600x190 pixel)</p>
                            <div class="row">
                              <div class="col">
                                  <img src="{{ asset('/assets/img/'.$bg->banner1) }}" width="300px"><br><br>
                                  <input type="file" name="banner1" class="form-control">
                              </div>
                              <div class="col">
                                  <img src="{{ asset('/assets/img/'.$bg->banner2) }}" width="300px"><br><br>
                                  <input type="file" name="banner2" class="form-control">
                              </div>
                              <div class="col">
                                  <img src="{{ asset('/assets/img/'.$bg->banner3) }}" width="300px"><br><br>
