            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="card">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBlog">Tambah Blog</button><br><br>
                    <div class="table-responsive">
                      <table class="table table-striped" id="ajax-data-category-blog">
                        <thead>
                            <tr>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="modalBlogLabel">Tambah Data Blog</h5>
