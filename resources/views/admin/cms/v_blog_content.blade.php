            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-3">
                        <a style="color:black" href="/admin/blog"><p>Kategori</p></a>
                      </div>
                      <div class="col">
                      <a style="color:black" href="/admin/content_blog"><p>Konten Blog</p></a>
                      </div>
                    </div><br>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalBlog">Tambah Data Konten</button><br><br>
                    <div class="table-responsive">
                      <table class="table table-striped" id="ajax-data-content-blog">
                        <thead>
                            <tr>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="modalBlogLabel">Tambah Data Konten</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form action="/admin/save_content_blog" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body">
                              ...
                              <textarea class="form-control" id="short_desc" name="short_desc"></textarea><br>
                              <label>Konten</label>
                              <textarea class="form-control" id="long_desc" name="long_desc"></textarea><br>
                            </div>
