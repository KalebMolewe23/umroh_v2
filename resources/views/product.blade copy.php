...
<body>
    ...
    <section class="home containers">
                ...
                <div class="card_pesan_paket">
                    <form action="/product/proses_save_buy_packet" method="post">
                        ...
                        <br><hr>
                            ...
                            <div class="pilih_lokasi_1">
                                <button style="width:100px" type="button" id="plane_button" onclick="plane_button_1()"><?= $departure_plane ?></button>
                            </div>
                            <div class="row_pilih_lokasi">

                                <div class="col_pilih_lokasi">
                                    <?php if($v_packet->id_ticket_1 == null){ ?>
        
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_2">
                                        <button style="width:100px" type="button" id="plane_button_2" onclick="plane_button_quad_2()"><?= $departure_plane_2 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_3">
                                        <button style="width:100px" type="button" id="plane_button_3" onclick="plane_button_quad_3()"><?= $departure_plane_3 ?></button>
                                    <?php } ?>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_4">
                                        <button style="width:100px" type="button" id="plane_button_4" onclick="plane_button_quad_4()"><?= $departure_plane_4 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_5">
                                        <button style="width:100px" type="button" id="plane_button_5" onclick="plane_button_quad_5()"><?= $departure_plane_5 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_6">
                                        <button style="width:100px" type="button" id="plane_button_6" onclick="plane_button_quad_6()"><?= $departure_plane_6 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_7">
                                        <button style="width:100px" type="button" id="plane_button_7" onclick="plane_button_quad_7()"><?= $departure_plane_7 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_8">
                                        <button style="width:100px" type="button" id="plane_button_8" onclick="plane_button_quad_8()"><?= $departure_plane_8 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="col_pilih_lokasi">
                                    ...
                                    <?php }else{ ?>
                                    <div class="pilih_lokasi_9">
                                        <button style="width:100px" type="button" id="plane_button_9" onclick="plane_button_quad_9()"><?= $departure_plane_9 ?></button>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
            ...
            <div class="data_pesan_paket_triple" id="data_pesan_paket_triple">
                <div class="card_pesan_paket">
                    <form action="/product/proses_save_buy_packet" method="post">
                        ...
                        Berangkat Dari<br><br>
                            <div class="pilih_lokasi_1">
                                <button type="button" id="plane_button_triple" onclick="plane_button_data_triple_1()"><?= $departure_plane ?></button>
                            </div>
                            <?php if($v_packet->id_ticket_1 == null){ ?>

                            <?php }else{ ?>
                            <div class="pilih_lokasi_2">
                                <button type="button" id="plane_button_triple_2" onclick="plane_button_data_triple_2()"><?= $departure_plane_2 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_3">
                                <button type="button" id="plane_button_triple_3" onclick="plane_button_data_triple_3()"><?= $departure_plane_3 ?></button>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_4">
                                <button type="button" id="plane_button_triple_4" onclick="plane_button_data_triple_4()"><?= $departure_plane_4 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_5">
                                <button type="button" id="plane_button_triple_5" onclick="plane_button_data_triple_5()"><?= $departure_plane_5 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_6">
                                <button type="button" id="plane_button_triple_6" onclick="plane_button_data_triple_6()"><?= $departure_plane_6 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_7">
                                <button type="button" id="plane_button_triple_7" onclick="plane_button_data_triple_7()"><?= $departure_plane_7 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_8">
                                <button type="button" id="plane_button_triple_8" onclick="plane_button_data_triple_8()"><?= $departure_plane_8 ?></button>
                            </div>
                            <?php } ?>
                            ...
                            <?php }else{ ?>
                            <div class="pilih_lokasi_9">
                                <button type="button" id="plane_button_triple_9" onclick="plane_button_data_triple_9()"><?= $departure_plane_9 ?></button>
                            </div>
                            <?php } ?>
                        <br><br><hr>
        ...
        <div class="card-container">
            ...
            <div class="card1">
                <h3>Fasilitas</h3><br><hr><br>

                <div class="row_product1">
                    <div class="col_product1">
                        <h4>Termasuk</h4>
                        <p>
                            - <?= $v_packet->in_facilitas ?><br>
                            
                            <!------------------Facilitas 1----------------->
                            <?php 
                                if($v_packet->in_facilitas_1 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_1 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 2----------------->
                            <?php 
                                if($v_packet->in_facilitas_2 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_2 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 3----------------->
                            <?php 
                                if($v_packet->in_facilitas_3 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_3 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 4----------------->
                            <?php 
                                if($v_packet->in_facilitas_4 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_4 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 5----------------->
                            <?php 
                                if($v_packet->in_facilitas_5 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_5 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 6----------------->
                            <?php 
                                if($v_packet->in_facilitas_6 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_6 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 7----------------->
                            <?php 
                                if($v_packet->in_facilitas_7 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_7 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 8----------------->
                            <?php 
                                if($v_packet->in_facilitas_8 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_8 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 9----------------->
                            <?php 
                                if($v_packet->in_facilitas_9 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_9 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 10----------------->
                            <?php 
                                if($v_packet->in_facilitas_10 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_10 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 11----------------->
                            <?php 
                                if($v_packet->in_facilitas_11 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_11 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 12----------------->
                            <?php 
                                if($v_packet->in_facilitas_12 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_12 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 13----------------->
                            <?php 
                                if($v_packet->in_facilitas_13 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_13 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 14----------------->
                            <?php 
                                if($v_packet->in_facilitas_14 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_14 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 15----------------->
                            <?php 
                                if($v_packet->in_facilitas_15 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_15 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 16----------------->
                            <?php 
                                if($v_packet->in_facilitas_16 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_16 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 17----------------->
                            <?php 
                                if($v_packet->in_facilitas_17 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_17 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 18----------------->
                            <?php 
                                if($v_packet->in_facilitas_18 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_18 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                            ...
                            <!------------------Facilitas 19----------------->
                            <?php 
                                if($v_packet->in_facilitas_19 == null){                            
                            ?>
                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->in_facilitas_19 ?><br>
                            <?php
                                }
                            ?>
                            <!----------------------------------------------->
                    ...
                    <div class="col_product1">
                        ...
                        <p>
                        - <?= $v_packet->out_facilitas ?><br>
                            <?php 
                                if($v_packet->out_facilitas_1 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_1 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_2 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_2 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_3 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_3 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_4 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_4 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_5 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_5 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_6 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_6 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_7 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_7 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_8 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_8 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_9 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_9 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_10 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_10 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_11 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_11 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_12 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_12 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_13 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_13 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_14 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_14 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_15 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_15 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_16 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_16 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_17 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_17 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_18 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_18 ?><br>
                            <?php
                                }
                            ?>
                            <?php 
                                if($v_packet->out_facilitas_19 == null){                            
                            ?>

                            <?php 
                                }else{
                            ?>
                            - <?= $v_packet->out_facilitas_19 ?><br>
                            <?php
                                }
                            ?>
                        </p>
        ...
        <div class="card-container">
            <div class="card1">
                <?php
                    ...
                    if($v_data_packets->name_hotel != null && $v_data_packets->name_hotel_2 == null && $v_data_packets->name_hotel_3 == null && $v_data_packets->name_hotel_4 == null && $v_data_packets->name_hotel_5 == null){
                ?>
                    <h3>Hotel</h3><br><br><br>
                    <h4><?= $v_data_packets->name_hotel; ?></h4>

                <?php }else if($v_data_packets->name_hotel != null && $v_data_packets->name_hotel_2 != null && $v_data_packets->name_hotel_3 == null && $v_data_packets->name_hotel_4 == null && $v_data_packets->name_hotel_5 == null){?>
                    <h3>Hotel</h3><br>
                    ...
                    <h4><i class='bx bx-current-location'></i> <?= $v_data_packets->address_hotel_2; ?></h4><br>
                    <h3>Fasilitas Populer</h3>
                    <i class='bx bx-wifi'></i>Free Wifi&nbsp;
                    <i class='bx bx-group' ></i> Ruang Keluarga&nbsp;
                    <i class='bx bx-accessibility'></i> Disabilitas<br>
        ...
        <h4>Paket Umroh Lainnya</h4><br>
            <div class="row_paket1">
                <div class="column_paket1">
                    <a href="/product" style="color: black">
                        <div class="card_paket">
                            <div class="row_isi_paket"><br>
                                <div class="column_isi_paket">
                                    <img src="https://cloud.umroh.com/images/upload/c_contain,f_auto,g_face,b_rgb:000000,dpr_2.0,h_391,w_627,q_80,fl_progressive/jamaah%20hamsa.jpeg" width="90px">
                                </div>
                                <div class="column_isi_paket">
                                    <h4>Paket Kareem</h4>
                                </div>
                            ...
                            <p>Quad, Sekamar ber-4</p>
                            <div class="processing">
                                <div class="processing-bar" data-bar="75">
                                    Processing 85%
                                </div>
                            </div><br>
                            <hr><br>
                            <div class="row_isi_paket">
                                <div class="column_isi_paket">
                                    <h4><i class='bx bxs-calendar' ></i> 08 Nov 2023</h4>
                                </div>
                                <div class="column_isi_paket">
                                    <h4><i class='bx bxs-hotel' ></i><i class='bx bxs-star' ></i> 4</h4>
                                </div>
                            </div>
                            <div class="row_isi_paket">
                                <div class="column_isi_paket">
                                    <h4><i class='bx bxs-plane-alt' ></i> Emirates</h4>
                                </div>
                                <div class="column_isi_paket">
                                    <h4><i class='bx bxs-time'></i> 9 Hari</h4>
                                </div>
                            </div>
                            <div class="row_isi_paket">
                                <div class="column_isi_paket">
                                    <h4><i class='bx bxs-map' ></i> Jakarta</h4>
                                </div>
                                <!-- <div class="column_isi_paket">
                                    <h4><i class='bx bxs-hotel' ></i><i class='bx bxs-star' ></i> 4</h4>
                                </div> -->
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#plane_button_2").click(function(){
                let harga = document.getElementById('price_total_jamaah');
                harga.value = parseInt(<?= $harga_paket_2 ?>);
                let formattedAmount = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(harga.value);
                document.getElementById('moneyDisplay').innerText = formattedAmount;
            });
            <?php } ?>
