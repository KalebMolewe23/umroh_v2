...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="/agen/savePartner_branch" method="post" enctype="multipart/form-data" id="input_cost_branch">
            @csrf
            <input type="hidden" name="id_user" value="<?= $id; ?>">
                <div class="card">
                    ...
                    <strong>Informasi Cabang</strong><br><br>
                        ...
                        <input class="form-control" name="cost" type="text" placeholder="Masukkan Biaya Transportasi & Akomodasi Lokal" id="cost" required>
                    </div>
                </div><br>
                <div align="right">
