...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="{{ url('/agen/proses_edit_agen/'.$agen->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="<?= $agen->id; ?>">
            <input type="hidden" name="id_user" value="<?= $agen->id_user; ?>">
            <div class="card">
            <div class="card-body">
                    <strong>Informasi Agen</strong><br><br>
                    <div class="row">
                        <div class="col">
                            <strong>Nama</strong><br>
                            <input class="form-control" name="name_agen" type="text" placeholder="Masukkan Nama" value="<?= $agen->name_agen ?>" required>
                        </div>
                        <div class="col">
                            <strong>No. Telp</strong><br>
                            <input class="form-control" name="phone_agen" type="text" placeholder="Masukkan Nomor Telefon Agen" value="<?= $agen->phone_agen ?>" required>
                        </div>
                      </div><br>
                    <div class="row">
                      <div class="col">
                        <strong>Email</strong>
                        <input class="form-control" name="email_agen" type="email" placeholder="Masukkan Nomor Hp" value="<?= $agen->email_agen ?>" required>
                      </div>
                      <div class="col">
                        <strong>Kota</strong>
                        <select class="form-control" name="city" required>
                          <option value="<?= $agen->city ?>"><?= $agen->city ?></option>
                          @foreach($city as $v_city) :
                            <option value="<?= $v_city->cityName ?>"><?= $v_city->cityName ?></option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    <br><div class="row">
                        <div class="col">
                            ...
                            <select class="form-control" name="bank" required>
                                <option value="<?= $agen->bank ?>"><?= $agen->bank ?></option>
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" name="number_rek" type="number" placeholder="Masukkan Nomor Rekening" value="<?= $agen->number_rek ?>" required>
                        </div>
                    </div><br>
                    <strong>Nama Bank</strong><br>
                    <select class="form-control" name="status" required>
                        <?php if($agen->status == "Aktif"){ ?>
