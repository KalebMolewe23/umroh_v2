...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="{{ url('/agen/proses_edit_partner/'.$cabang->id) }}" method="post" enctype="multipart/form-data" id="input_cost_branch">
            @csrf
            <input type="hidden" name="id" value="<?= $cabang->id; ?>">
            <input type="hidden" name="id_user" value="<?= $cabang->id_user; ?>">
                <div class="card">
                    <div class="card-body">
                    <strong>Informasi Cabang</strong><br><br>
                        <strong>Kota</strong><br>
                        <select class="form-control" name="city" required>
                        <option value="<?= $cabang->city ?>"><?= $cabang->city ?></option>
                        @foreach($city as $v_city)
                            <option value="<?= $v_city->city ?>"><?= $v_city->city ?></option>
                        @endforeach
                        </select><br>
                        <strong>Tambah Biaya Transportasi & Akomodasi Lokal</strong>
                        <input class="form-control" name="cost" type="text" value="<?= $cabang->cost; ?>" placeholder="Masukkan Biaya Transportasi & Akomodasi Lokal" id="cost" required>
                    </div>
                </div><br>
                <div align="right">
