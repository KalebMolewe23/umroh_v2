                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input class="form-control" name="name_agen" type="text" placeholder="Masukkan Nama" required>
                        </div>
                        <div class="col">
                            <strong>No. Telp</strong><br>
                            <input class="form-control" name="phone_agen" type="text" placeholder="Masukkan Nomor Telefon Agen" required>
                        </div>
                      </div><br>
                    <div class="row">
                      <div class="col">
                        <strong>Email</strong>
                        <input class="form-control" name="email_agen" type="email" placeholder="Masukkan Nomor Hp" required>
                      </div>
                      <div class="col">
                        <strong>Kota</strong>
                        <select class="form-control" name="city" required>
                          <option value=""> -Pilih Kota Agen- </option>
                    ...
                    <br><div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" name="number_rek" type="number" placeholder="Masukkan Nomor Rekening" required>
                        </div>
                    </div><br>
                </div>
            </div><br>
