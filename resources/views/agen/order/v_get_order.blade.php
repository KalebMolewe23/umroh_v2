        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ url('/agen/export_excel_transaction'); }}" class="btn btn-success"><i class='bx bx-file'></i> Export</a><br><br>
                            <div class="d-flex align-items-end row">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="ajax-crud-order-datatable">
                                        <thead>
                                            <tr>
