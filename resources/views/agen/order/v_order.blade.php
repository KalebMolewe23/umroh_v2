        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
                <div class="card-body">
                    1. Data Jamaah
                    <br><br>
                    <h5>Pilih Pemesanan</h5>
                    <select class="data_user" class="form-control" id="select-customer" style="width: 200px;">
                            <option value= ""> -Pilih Data Pemesanan- </option>
                        @foreach($customer as $v_customer)
                            <option value="{{ $v_customer->id }}" data-name="{{ $v_customer->name }}" data-ktp="{{ $v_customer->ktp }}" data-email="{{ $v_customer->email }}" data-phone="{{ $v_customer->phone }}" data-father_name="{{ $v_customer->father_name }}" data-blood_groub="{{ $v_customer->blood_groub }}" data-born_place="{{ $v_customer->born_place }}" data-date_of_birth="{{ $v_customer->date_of_birth }}" data-marital_status="{{ $v_customer->marital_status }}" data-title="{{ $v_customer->title }}" data-gender="{{ $v_customer->gender }}" data-citizenship="{{ $v_customer->citizenship }}" data-id_province="{{ $v_customer->id_province }}" data-id_regencies="{{ $v_customer->id_regencies }}" data-address="{{ $v_customer->address }}" data-education="{{ $v_customer->education }}" data-job="{{ $v_customer->job }}" data-status_umroh="{{ $v_customer->status_umroh }}" data-passport_name="{{ $v_customer->passport_name }}" data-passport_number="{{ $v_customer->passport_number }}" data-passport_place="{{ $v_customer->passport_place }}" data-passport_date="{{ $v_customer->passport_date }}" data-expired="{{ $v_customer->expired }}" data-companion_name="{{ $v_customer->companion_name }}" data-connection="{{ $v_customer->connection }}">{{ $v_customer->name }}</option>
                        @endforeach
                    </select><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <h5>No. KTP</h5>
                            <input type="text" class="form-control" id="customer-ktp" name="ktp" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Email</h5>
                            <input type="text" class="form-control" maxlength="255" id="customer-email" name="email" required>
                        </div>
                        <div class="col">
                            <h5>No. Telp</h5>
                            <input type="text" class="form-control" maxlength="20" id="customer-phone" name="phone" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Nama Ayah</h5>
                            <input type="text" class="form-control" maxlength="200" id="customer-father_name" name="father_name" required>
                        </div>
                        <div class="col">
                            <h5>Golongan Darah</h5>
                            <select name="blood_groub" id="customer-blood_groub" class="form-control" required>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Tempat Lahir</h5>
                            <input type="text" class="form-control" maxlength="200" id="customer-born_place" name="born_place" required>
                        </div>
                        <div class="col">
                            <h5>Tanggal Lahir</h5>
                            <input type="date" class="form-control" id="customer-date_of_birth" name="date_of_birth" required>
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="marital_status" id="customer-marital_status" class="form-control" required>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Jenis Kelamin</h5>
                            <select name="gender" id="customer-gender" class="form-control" required>
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" maxlength="200" id="customer-citizenship" name="citizenship">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Provinsi</h5>
                            <select name="id_province" id="customer-id_province" class="form-control" required>
                                <option value=""> -Pilih Jenis Kelamin- </option>
                        ...
                        <div class="col">
                            <h5>Kota</h5>
                            <select class="form-control" id="customer-id_regencies" name="id_regencies" required>
                                <option value=""> -Pilih Kota- </option>
                                <?php $regencies = DB::table('regencies')->get(); ?>
                                @foreach($regencies as $v_regencies)
                                    <option value="<?= $v_regencies->id ?>"><?= $v_regencies->name ?></option>
                                @endforeach
                            </select>
                        </div>
                    </div><br>
                    ...
                    <h5>Alamat</h5>
                    <input class="form-control" maxlength="200" id="customer-address" name="address"><br>

                    <div class="row">
                        <div class="col">
                            <h5>Pendidikan Terakhir</h5>
                            <input class="form-control" maxlength="200" id="customer-education" name="education">
                        </div>
                        <div class="col">
                            <h5>Pekerjaan</h5>
                            <input class="form-control" maxlength="200" id="customer-job" name="job">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Umroh/Haji</h5>
                            <select name="status_umroh" id="customer-status_umroh" class="form-control" required>
                        ...
                        <div class="col">
                            <h5>Nama Passpor</h5>
                            <input class="form-control" maxlength="200" id="customer-passport_name" name="passport_name">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5>Nomor Passpor</h5>
                            <input class="form-control" maxlength="200" id="customer-passport_number" name="passport_number">
                        </div>
                        <div class="col">
                            <h5>Tempat Pembuatan</h5>
                            <input class="form-control" maxlength="200" id="customer-passport_place" name="passport_place">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input class="form-control" type="date" id="customer-passport_date" name="passport_date">
                        </div>
                        <div class="col">
                            <h5>Batas Waktu</h5>
                            <input class="form-control" type="date" id="customer-expired" name="expired">
                        </div>
                    </div><br>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input class="form-control" id="customer-companion_name" name="companion_name">
                        </div>
                        <div class="col">
                            <h5>Hubungan</h5>
                    ...
                    <select class="data_packet" class="form-control" id="select-packet" style="width: 200px;">
                        ...
                        @foreach($packet as $v_packet)
                            <option value="{{ $v_packet->id }}" data-name_packet="{{ $v_packet->name_packet }}" data-quad_1="{{ $v_packet->quad_1 }}" data-triple_1="{{ $v_packet->triple_1 }}" data-double_1="{{ $v_packet->double_1 }}" data-dp="{{ $v_packet->dp }}">{{ $v_packet->name_packet }}</option>
                        @endforeach
                    </select><br><br>

                    Nama Paket : 
                    <input type="text" style="border:none;background-color:white;width:300px" id="packet-name_packet" disabled><br>

                    Quad : 
                    <input type="text" style="border:none;background-color:white;width:300px" id="packet-quad_1" disabled><br>

                    Triple :
                    <input type="text" style="border:none;background-color:white;width:300px" id="packet-triple_1" disabled><br>
                    
                    Double :
                    <input type="text" style="border:none;background-color:white;width:300px" id="packet-double_1" disabled><br>
                    
                    DP :
                    <input type="text" style="border:none;background-color:white;width:300px" id="packet-dp" disabled><br>
