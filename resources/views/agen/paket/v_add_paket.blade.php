...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="/agen/proses_save_packet" method="post" enctype="multipart/form-data" id="input_paket_tiket"><br>
            @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <input class="form-control" maxlength="50" name="name_packet" type="text" placeholder="Masukkan Nama Paket" required><br>
                        <h5 class="m-0 me-2">Tiket Group</h5>
                        <p>Jadwal, kota, maskapai serta kapasitas seat disesuaikan dengan Tiket Group. Untuk menambahkan Tiket Group<a href="/agen/add_ticket_group"> Silahkan Klik Disini</a></p>
                        <div class="row">
                            <div class="col">
                                <select class="form-control" name="id_ticket" id="maskapai" required>
                                    <option value="">Pilih Tiket Group</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" name="maskapai_name" type="text" placeholder="Maskapai Penerbangan" id="penerbangan" required readonly>
                            </div>
                            <div class="col">
                                <h5 class="m-0 me-2">Kota</h5>
                                <input class="form-control" name="departure_city" type="hidden" placeholder="Kota Keberangkatan" id="kota_save" required>
                                <input class="form-control" type="text" placeholder="Kota Keberangkatan" id="kota" required readonly>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                <h5 class="m-0 me-2">Jadwal</h5>
                                <input class="form-control" name="departure_date" type="text" placeholder="Jadwal Keberangkatan" id="jadwal" required readonly>
                            </div>
                            <div class="col">
                                <h5 class="m-0 me-2">Kapasitas Seat</h5>
                                <input class="form-control" name="seat_capasitas" type="text" placeholder="Kapasitas Seat" id="seat" required readonly>
                            </div>
                        </div><br>
                        <h5 class="m-0 me-2">Set Uang Muka</h5>
                        <input class="form-control" name="dp" type="text" placeholder="Uang Muka" id="dp_paket" required>
                </div>
            </div><br>
            <div align="right">
