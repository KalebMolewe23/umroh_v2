                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="type_1">
                            ...
                            <strong>Quad</strong>
                            <input class="form-control" name="quad_1" type="text" id="quad_1" placeholder="Masukkan Harga Type Quad" required>
                            <strong>Triple</strong>
                            <input class="form-control" name="triple_1" type="text" id="triple_1" placeholder="Masukkan Harga Type Triple">
                            <strong>Double</strong>
                            <input class="form-control" name="double_1" type="text" id="double_1" placeholder="Masukkan Harga Type Double"><br>
                        ...
                        <div id="type_2">
                            ...
                            <strong>Quad</strong>
                            <input class="form-control" name="quad_2" id="quad_2" type="text" placeholder="Masukkan Harga Type Quad">
                            <strong>Triple</strong>
                            <input class="form-control" name="triple_2" id="triple_2" type="text" placeholder="Masukkan Harga Type Triple">
                            <strong>Double</strong>
                            <input class="form-control" name="double_2" id="double_2" type="text" placeholder="Masukkan Harga Type Double"><br>
                        ...
                        <div id="type_3">
                            ...
                            <input class="form-control" name="quad_3" id="quad_3" type="text" placeholder="Masukkan Harga Type Quad"><br><br>
                            <strong>Triple</strong><br>
                            <input class="form-control" name="triple_3" id="triple_3" type="text" placeholder="Masukkan Harga Type Triple"><br><br>
                            <strong>Double</strong><br>
                            <input class="form-control" name="double_3" id="double_3" type="text" placeholder="Masukkan Harga Type Double"><br><br>
                        </div>
