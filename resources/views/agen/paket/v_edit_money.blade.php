...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="{{ url('/agen/proccess_update_money/'.$money->id) }}" method="post" enctype="multipart/form-data" id="input_money">
            @csrf
            <input type="hidden" name="id" value="<?= $money->id; ?>">
            <input type="hidden" name="id_user" value="<?= $money->id_user; ?>">
            <input type="hidden" name="id_hotel" value="<?= $money->id_hotel; ?>">
            <input type="hidden" name="id_packet" value="<?= $money->id_packet; ?>"><br>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                1. <a style="color:black;" href="{{ url('/agen/edit_paket/'.$money->id_packet) }}"><i class='bx bxs-info-circle' ></i> Informasi Paket</a>
                            </div>
                            <div class="col">
                                2. <a style="color:black;" href="{{ url('/agen/edit_hotel/'.$money->id_packet) }}"><i class='bx bxs-buildings'></i> Hotel</a>
                            </div>
                            <div class="col">
                                3. <a style="color:black;" href="{{ url('/agen/edit_money/'.$money->id_packet) }}"><i class='bx bx-money' ></i> Harga</a>
                            </div>
                            <div class="col">
                                4. <a style="color:black;" href="{{ url('/agen/edit_fasilitas/'.$money->id_packet) }}"><i class='bx bxs-hand-up'></i> Fasilitas</a>
                            </div>
                            <div class="col">
                                5. <a style="color:black;" href="{{ url('/agen/edit_condition/'.$money->id_packet) }}"><i class='bx bx-list-check'></i> Syarat & Ketentuan</a>
                            </div>
                            <div class="col">
                                6. <a style="color:black;" href="{{ url('/agen/edit_photo/'.$money->id_packet) }}"><i class='bx bxs-camera-movie'></i> Foto & Video</a>
                            </div><br><br>
                            <strong>Informasi Harga</strong><br><br>
                            <strong>Informasi Harga Bayi(< 2 Tahun)</strong><br>
                            <input class="form-control" name="price_baby" type="text" value="<?= $money->price_baby; ?>" placeholder="Masukkan Harga Bayi" id="price_baby"><br><br>
                            <strong>Informasi Harga Anak(2 - 5 Tahun)</strong><br>
                            <input class="form-control" name="price_child" type="text" value="<?= $money->price_child; ?>" placeholder="Masukkan Harga Anak" id="price_child"><br><br>
                            <strong>Informasi Harga Dewasa</strong><br>
                            <input class="form-control" name="price_adult" type="text" value="<?= $money->price_adult; ?>" placeholder="Masukkan Harga Dewasa" id="price_adult"><br><br>
                        </div>
                    </div>
                </div><br>
                <div align="right">
