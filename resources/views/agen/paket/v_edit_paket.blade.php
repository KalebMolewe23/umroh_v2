...
?>
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ url('/agen/proccess_update_packet/'.$packet->id) }}" method="post" enctype="multipart/form-data" id="input_paket_tiket">
            @csrf
            <input type="hidden" name="id" value="<?= $packet->id; ?>">
            <input type="hidden" name="id_user" value="<?= $packet->id_user; ?>">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <div class="col">
                        ...
                        <h5 class="m-0 me-2">Maskapai Penerbangan Keberangkatan</h5><br>
                        <h5 class="m-0 me-2">Nama Paket</h5>
                        <input class="form-control" maxlength="50" name="name_packet" type="text" value="<?= $packet->name_packet; ?>" placeholder="Masukkan Nama Paket" required><br>
                        <h5 class="m-0 me-2">Tiket Group</h5>
                        <div class="row">
                            <div class="col">
                                <select class="form-control" name="id_ticket" id="maskapai" required>
                            ...
                            <div class="col">
                                <select class="form-control" name="id_category_packet" id="maskapai" required>
                                    <?php $data_kategori = DB::table('packets')->join('packet_categories', 'packet_categories.id', '=', 'packets.id_category_packet')->where('packets.id', $packet->id)->first(); ?>
                                    <option value="<?= $data_kategori->id_category_packet ?>"><?= $data_kategori->categorie_name ?></option>
                        ...
                        <div class="row">
                            <div class="col">
                                <h5 class="m-0 me-2">Maskapai</h5>
                                <input class="form-control" name="maskapai_name" type="text" value="<?= $packet->maskapai_name; ?>" placeholder="Maskapai Penerbangan" id="penerbangan" required readonly>
                            </div>
                            <div class="col">
                                <h5 class="m-0 me-2">Kota</h5>
                                <input class="form-control" name="departure_city" type="hidden" placeholder="Kota Keberangkatan" value="<?= $packet->departure_city; ?>" id="kota_save" required>
                                <input class="form-control" type="text" placeholder="Kota Keberangkatan" value="<?= $packet->departure_city; ?>" id="kota" required readonly>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                <h5 class="m-0 me-2">Jadwal</h5>
                                <input class="form-control" name="departure_date" type="text" value="<?= $packet->departure_date; ?>" placeholder="Jadwal Keberangkatan" id="jadwal" required readonly>
                            </div>
                            <div class="col">
                                <h5 class="m-0 me-2">Kapasitas Seat</h5>
                                <input class="form-control" name="seat_capasitas" type="text" placeholder="Kapasitas Seat" value="<?= $packet->seat_capasitas; ?>" id="seat" required readonly>
                            </div>
                        </div><br>
                        <h5 class="m-0 me-2">Set Uang Muka</h5>
                        <input class="form-control" name="dp" type="text" placeholder="Uang Muka" value="<?= $packet->dp; ?>" id="dp_paket" required>
                </div>
            </div><br>
            <div align="right">
