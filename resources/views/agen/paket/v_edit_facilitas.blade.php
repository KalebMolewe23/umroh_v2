...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="{{ url('/agen/proccess_update_facilitas/'.$facilitas->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <input type="hidden" name="id_packet" value="<?= $facilitas->id_packet; ?>">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <strong>Informasi Fasilitas</strong><br><br>
                        ...
                        <input class="form-control" name="in_facilitas" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas ?>" id="in_facilitas" required><br><br>
                        ...
                        <div id="facilitas_in">
                            <input class="form-control" name="in_facilitas_1" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_1 ?>" id="in_facilitas_1"><br><br>
                        ...
                        <div id="facilitas_in_2">
                            <input class="form-control" name="in_facilitas_2" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_2 ?>" id="in_facilitas_2"><br><br>
                        ...
                        <div id="facilitas_in_3">
                            <input class="form-control" name="in_facilitas_3" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_3 ?>" id="in_facilitas_3"><br><br>
                        ...
                        <div id="facilitas_in_4">
                            <input class="form-control" name="in_facilitas_4" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_4 ?>" id="in_facilitas_4"><br><br>
                        ...
                        <div id="facilitas_in_5">
                            <input class="form-control" name="in_facilitas_5" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_5 ?>" id="in_facilitas_5"><br><br>
                        ...
                        <div id="facilitas_in_6">
                            <input class="form-control" name="in_facilitas_6" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_6 ?>" id="in_facilitas_6"><br><br>
                        ...
                        <div id="facilitas_in_7">
                            <input class="form-control" name="in_facilitas_7" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_7 ?>" id="in_facilitas_7"><br><br>
                        ...
                        <div id="facilitas_in_8">
                            <input class="form-control" name="in_facilitas_8" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_8 ?>" id="in_facilitas_8"><br><br>
                        ...
                        <div id="facilitas_in_9">
                            <input class="form-control" name="in_facilitas_9" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->in_facilitas_9 ?>" id="in_facilitas_9"><br><br>
                        </div>

                        <br><br><strong>Yang Tidak Termasuk</strong><br>    
                        <input class="form-control" name="out_facilitas" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas ?>" id="out_facilitas" required><br><br>
                        ...
                        <div id="facilitas_out">
                            <input class="form-control" name="out_facilitas_1" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_1 ?>" id="out_facilitas_1"><br><br>
                        ...
                        <div id="facilitas_out_2">
                            <input class="form-control" name="out_facilitas_2" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_2 ?>" id="out_facilitas_2"><br><br>
                        ...
                        <div id="facilitas_out_3">
                            <input class="form-control" name="out_facilitas_3" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_3 ?>" id="out_facilitas_3"><br><br>
                        ...
                        <div id="facilitas_out_4">
                            <input class="form-control" name="out_facilitas_4" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_4 ?>" id="out_facilitas_4"><br><br>
                        ...
                        <div id="facilitas_out_5">
                            <input class="form-control" name="out_facilitas_5" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_5 ?>" id="out_facilitas_5"><br><br>
                        ...
                        <div id="facilitas_out_6">
                            <input class="form-control" name="out_facilitas_6" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_6 ?>" id="out_facilitas_6"><br><br>
                        ...
                        <div id="facilitas_out_7">
                            <input class="form-control" name="out_facilitas_7" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_7 ?>" id="out_facilitas_7"><br><br>
                        ...
                        <div id="facilitas_out_8">
                            <input class="form-control" name="out_facilitas_8" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_8 ?>" id="out_facilitas_8"><br><br>
                        ...
                        <div id="facilitas_out_9">
                            <input class="form-control" name="out_facilitas_9" type="text" maxlength="255" placeholder="Masukkan Informasi Fasilitas" value="<?= $facilitas->out_facilitas_9 ?>" id="out_facilitas_9"><br><br>
                        </div>
                </div>
            </div>
            <br><br>
