...
?>
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ url('/agen/proses_edit_foto/'.$photo->id) }}" method="post" enctype="multipart/form-data" id="uploadForm">
            ...
            <input type="hidden" name="id_hotel" value="<?= $photo->id_hotel; ?>">
            <div class="card">
                <div class="card-body">
                <div class="row">
                        <div class="col">
                    ...
                    <input class="form-control" name="image" type="file" id="image" accept="image/*" required><br>
                    ...
                    <input class="form-control" name="video" id="video" type="file" accept="video/*"><br>
                </div>
            </div><br>
            <div align="right">
