...
?>
    ...
    <div class="content-wrapper">
        ...
        <form action="/agen/proses_save_money_packet" method="post" enctype="multipart/form-data" id="input_money">
            @csrf
            <input type="hidden" name="id_user" value="<?= $id; ?>">
            <input type="hidden" name="id_hotel" value="<?= $id_product->id; ?>">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <input class="form-control" name="price_baby" type="text" placeholder="Masukkan Harga Bayi" id="price_baby" required><br>
                    <h5 class="m-0 me-2">Informasi Harga Anak(2 - 5 Tahun)</h5>
                    <input class="form-control" name="price_child" type="text" placeholder="Masukkan Harga Anak" id="price_child" required><br>
                    <h5 class="m-0 me-2">Informasi Harga Dewasa</h5>
                    <input class="form-control" name="price_adult" type="text" placeholder="Masukkan Harga Dewasa" id="price_adult" required>
                </div>
            </div><br>
            <div align="right">
