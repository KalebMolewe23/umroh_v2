...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="/agen/proses_save_itinerary" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id_user" value="<?= $id; ?>">
                <div class="card">
                    <div class="card-body">
                        <h5 class="m-0 me-2">Jadwal Perjalanan</h5><br><br>
                        ...
                        <h5 class="m-0 me-2">Hari Ke-1</h5>
                        <input class="form-control" name="activity" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Pertama" id="activity" required><br>
                        <h5 class="m-0 me-2">Hari Ke-2</h5>
                        <input class="form-control" name="activity_2" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-dua" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-3</h5>
                        <input class="form-control" name="activity_3" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-tiga" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-4</h5>
                        <input class="form-control" name="activity_4" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-keempat" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-5</h5>
                        <input class="form-control" name="activity_5" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-kelima" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-6</h5>
                        <input class="form-control" name="activity_6" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-keenam" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-7</h5>
                        <input class="form-control" name="activity_7" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-ketujuh" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-8</h5>
                        <input class="form-control" name="activity_8" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-delapan" id="activity"><br>
                        <h5 class="m-0 me-2">Hari Ke-9</h5>
                        <input class="form-control" name="activity_9" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        ...
                        <div id="activity_10">
                            <h5 class="m-0 me-2">Hari Ke-10</h5>
                            <input class="form-control" name="activity_10" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        ...
                        <div id="activity_11">
                            <h5 class="m-0 me-2">Hari Ke-11</h5>
                            <input class="form-control" name="activity_11" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        ...
                        <div id="activity_12">
                            <h5 class="m-0 me-2">Hari Ke-12</h5>
                            <input class="form-control" name="activity_12" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        ...
                        <div id="activity_13">
                            <h5 class="m-0 me-2">Hari Ke-13</h5>
                            <input class="form-control" name="activity_13" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        ...
                        <div id="activity_14">
                            <h5 class="m-0 me-2">Hari Ke-14</h5>
                            <input class="form-control" name="activity_14" type="text" maxlength="255" placeholder="Masukkan Kegiatan Hari Ke-sembilan" id="activity"><br>
                        </div>
                    </div>
                </div><br>
                <div align="right">
