...
?>
    ...
    <div class="content-wrapper">
        ...
        <input type="hidden" name="id_hotel" value="<?= $condition->id_hotel; ?>">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <input class="form-control" name="in_condition" type="text" maxlength="255" value="<?= $condition->in_condition; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition" required><br>
                        ...
                        <div id="condition">
                            <input class="form-control" name="in_condition_1" type="text" maxlength="255" value="<?= $condition->in_condition_1; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_1"><br>
                        ...
                        <div id="condition_2">
                            <input class="form-control" name="in_condition_2" type="text" maxlength="255" value="<?= $condition->in_condition_2; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_2"><br>
                        ...
                        <div id="condition_3">
                            <input class="form-control" name="in_condition_3" type="text" maxlength="255" value="<?= $condition->in_condition_3; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_3"><br>
                        ...
                        <div id="condition_4">
                            <input class="form-control" name="in_condition_4" type="text" maxlength="255" value="<?= $condition->in_condition_4; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_4"><br>
                        ...
                        <div id="condition_5">
                            <input class="form-control" name="in_condition_5" type="text" maxlength="255" value="<?= $condition->in_condition_5; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_5"><br>
                        ...
                        <div id="condition_6">
                            <input class="form-control" name="in_condition_6" type="text" maxlength="255" value="<?= $condition->in_condition_6; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_6"><br>
                        ...
                        <div id="condition_7">
                            <input class="form-control" name="in_condition_7" type="text" maxlength="255" value="<?= $condition->in_condition_7; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_7"><br>
                        ...
                        <div id="condition_8">
                            <input class="form-control" name="in_condition_8" type="text" maxlength="255" value="<?= $condition->in_condition_8; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_8"><br>
                        ...
                        <div id="condition_9">
                            <input class="form-control" name="in_condition_9" type="text" maxlength="255" value="<?= $condition->in_condition_9; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_9"><br>
                        ...
                        <div id="condition_10">
                            <input class="form-control" name="in_condition_10" type="text" maxlength="255" value="<?= $condition->in_condition_10; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_10"><br>
                        ...
                        <div id="condition_11">
                            <input class="form-control" name="in_condition_11" type="text" maxlength="255" value="<?= $condition->in_condition_11; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_11"><br>
                        ...
                        <div id="condition_12">
                            <input class="form-control" name="in_condition_12" type="text" maxlength="255" value="<?= $condition->in_condition_12; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_12"><br>
                        ...
                        <div id="condition_13">
                            <input class="form-control" name="in_condition_13" type="text" maxlength="255" value="<?= $condition->in_condition_13; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_13"><br>
                        ...
                        <div id="condition_14">
                            <input class="form-control" name="in_condition_14" type="text" maxlength="255" value="<?= $condition->in_condition_14; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_14"><br>
                        ...
                        <div id="condition_15">
                            <input class="form-control" name="in_condition_15" type="text" maxlength="255" value="<?= $condition->in_condition_15; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_15"><br>
                        ...
                        <div id="condition_16">
                            <input class="form-control" name="in_condition_16" type="text" maxlength="255" value="<?= $condition->in_condition_16; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_16"><br>
                        ...
                        <div id="condition_17">
                            <input class="form-control" name="in_condition_17" type="text" maxlength="255" value="<?= $condition->in_condition_17; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_17"><br>
                        ...
                        <div id="condition_18">
                            <input class="form-control" name="in_condition_18" type="text" maxlength="255" value="<?= $condition->in_condition_18; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_18"><br>
                        ...
                        <div id="condition_19">
                            <input class="form-control" name="in_condition_19" type="text" maxlength="255" value="<?= $condition->in_condition_19; ?>" placeholder="Masukkan Syarat Dan Ketentuan" id="in_condition_19"><br>
                        </div>
                </div>
            </div>
            <br>
