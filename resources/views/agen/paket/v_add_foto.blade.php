...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <form action="/agen/proses_save_foto" method="post" enctype="multipart/form-data" id="uploadForm">
                @csrf
                <input type="hidden" name="id_user" value="<?= $id; ?>">
                <input type="hidden" name="id_condition" value="<?= $id_product->id; ?>">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="m-0 me-2">Informasi Foto Dan Video</h5>
                        <p style="color:red">(Keterangan : Foto Wajib Diisi.)</p>
                        <h5 class="m-0 me-2">Upload Foto (Max size: 5MB)</h5><br>
                        <input class="travel_upload_video" name="image" type="file" id="image" accept="image/*" required><br><br>
                        <h5 class="m-0 me-2">Upload Video (Max Size: 20MB)</h5><br>
