...
?>
    ...
    <div class="content-wrapper">
        ...
        ?>
            ...
            <div align="left">
                <a href="{{ url('agen/person_responsible/'.$id) }}"><button type="submit" class="btn btn-default"><i class='bx bx-arrow-back'></i> Sebelumnya</button></a>
            </div><br>
            <form action="{{ url('/agen/proses_save_money/'.$id) }}" method="post" enctype="multipart/form-data" id="input_commision">
                @csrf
                <div class="card"><br>
                    <div class="card-body">
                        ...
                        <input class="form-control" name="number_rek" type="text" placeholder="Masukkan Nomor Rekening" required><br>
                        <strong>Nama Pemilik Rekening</strong>
                        <input class="form-control" name="owner_rek" type="text" placeholder="Masukkan Nama Pemilik Rekening" required><br><hr><br>
                        ...
                        <input class="form-control" name="commision" type="text" placeholder="Contoh : 1,000,000" id="commision" required><br><br>
                        <div align="right">
        ...
        <?php }else{ ?>
            ...
            <form action="{{ url('/agen/proses_update_money/'.$id_money) }}" method="post" enctype="multipart/form-data" id="input_commision">
                @csrf
                <div class="card"><br>
                    <div class="card-body">
                        <strong>Data Keuangan</strong>
                        ...
                        <br>
                        <strong>Nomor Rekening</strong>
                        <input class="form-control" name="number_rek" type="text" placeholder="Masukkan Nomor Rekening" value="<?= $number_rek ?>" required><br>
                        <strong>Nama Pemilik Rekening</strong>
                        <input class="form-control" name="owner_rek" type="text" placeholder="Masukkan Nama Pemilik Rekening" value="<?= $owner_rek ?>" required><br><hr><br>
                        <strong>Data Komisi Agen</strong>
                        <p>Tentukan nilai komisi untuk agen yang memasarkan paket umroh anda</p>
                        <strong>Nilai Komisi Agen</strong>
                        <input class="form-control" name="commision" type="text" placeholder="Contoh : 1,000,000" id="commision" value="<?= $commision ?>" required><br><br>
                        <div align="right">
                            <button type="submit" class="btn btn-primary"><i class='bx bxs-memory-card'></i> Selanjutnya</button>
                        </div><br>
                    </div>
