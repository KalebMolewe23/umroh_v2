    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            ?>
                ...
                <form action="{{ url('/agen/proses_save_travel/'.$id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" name="travel_name" maxlength="16" type="text" placeholder="Masukkan Nama Travel" required>
                            </div>
                            <div class="col">
                                <strong>Nama Perusahaan</strong><br>
                                <input class="form-control" name="employee_name" type="text" placeholder="Masukkan Nama Perusahaan (Nama PT)" required>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                <strong>Nomor Ijin Umroh(Wajib Diisi)</strong><br>
                                <input class="form-control" name="number_umroh" type="text" placeholder="Masukkan Nomor Ijin Umroh" required>
                            </div>
                            <div class="col">
                                <strong>Nomor Ijin Haji (Opsional)</strong><br>
                                <input class="form-control" name="number_haji" type="text" placeholder="Masukkan Ijin Haji (Opsional)">
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                        ...
                        <input class="form-control" name="address" type="text" placeholder="Masukkan Nama Jalan, Gedung, Nomor Rumah, Dan Lainnya" required><br>
                        <strong>Email Travel</strong>
                        <input class="form-control" name="email" type="email" placeholder="iniemailanda@gmail.com" required><br>
                        <div align="right">
