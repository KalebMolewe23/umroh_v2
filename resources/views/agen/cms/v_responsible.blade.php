    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            ?>
                    ...
                    <div align="left">
                        <a href="{{ url('agen/travel_information/'.$id) }}"><button type="submit" class="btn btn-default"><i class='bx bx-arrow-back'></i> Sebelumnya</button></a>
                    </div><br>
                    <form action="{{ url('/agen/proses_save_resposibles/'.$id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card"><br>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input class="form-control" name="name_responsibles" type="text" placeholder="Masukkan Nama Penanggung Jawab" required>
                                </div>
                                <div class="col">
                                    <strong>Jabatan</strong><br>
                                    <input class="form-control" name="role_responsibles" type="text" placeholder="Masukkan Jabatan Penanggung Jawab" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                    <strong>Nomor KTP</strong><br>
                                    <input class="form-control" name="ktp" type="text" placeholder="Masukkan Nomor KTP Penanggung Jawab" required>
                                </div>
                                <div class="col">
                                    <strong>Nomor NPWP</strong><br>
                                    <input class="form-control" name="npwp" type="text" placeholder="Masukkan Nomor NPWP Penanggung Jawab" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                    <strong>Email</strong><br>
                                    <input class="form-control" name="email" type="text" placeholder="Masukkan Email Penanggung Jawab" required>
                                </div>
                                <div class="col">
                                    <strong>Nomor Hp</strong><br>
                                    <input class="form-control" name="phone" type="text" placeholder="Masukkan Nomor Hp Penanggung Jawab" required>
                                </div>
                            </div><br>
                            <div align="right">
                ...
                <?php }else{ ?>
                    <?php 
                        ...
                        if($data_travel->is_verifition == 0){ ?>
                        <div class="card">
                        <div class="card-body">
                            <strong>Ikuti langkah berikut untuk mengaktifkan akun Anda</strong><br>
                            <div class="row">
                    ...
                    <div align="left">
                        <a href="{{ url('agen/travel_information/'.$data_travel->id_user) }}"><button type="submit" class="btn btn-default"><i class='bx bx-arrow-back'></i> Sebelumnya</button></a>
                    </div><br>
                    ...
                    <div class="card"><br>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <strong>Penanggung Jawab</strong><br>
                                    <input class="form-control" name="name_responsibles" type="text" placeholder="Masukkan Nama Penanggung Jawab" value="<?= $name_responsibles ?>" required>
                                </div>
                                <div class="col">
                                    <strong>Jabatan</strong><br>
                                    <input class="form-control" name="role_responsibles" type="text" placeholder="Masukkan Jabatan Penanggung Jawab" value="<?= $role_responsibles ?>" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                    <strong>Nomor KTP</strong><br>
                                    <input class="form-control" name="ktp" type="text" placeholder="Masukkan Nomor KTP Penanggung Jawab" value="<?= $ktp ?>" required>
                                </div>
                                <div class="col">
                                    <strong>Nomor NPWP</strong><br>
                                    <input class="form-control" name="npwp" type="text" placeholder="Masukkan Nomor NPWP Penanggung Jawab" value="<?= $npwp ?>" required>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col">
                                    <strong>Email</strong><br>
                                    <input class="form-control" name="email" type="text" placeholder="Masukkan Email Penanggung Jawab" value="<?= $email ?>" required>
                                </div>
                                <div class="col">
                                    <strong>Nomor Hp</strong><br>
                                    <input class="form-control" name="phone" type="text" placeholder="Masukkan Nomor Hp Penanggung Jawab" value="<?= $phone ?>" required>
                                </div>
                            </div><br>
                            <div align="right">
                                <button type="submit" class="btn btn-primary"><i class='bx bxs-memory-card'></i> Selanjutnya</button>
