    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
                <div class="card-body">
                    <?php 
                        $deadline = DB::table('settingdue_dates')->where('id_user', $id)->get(); 
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="table-responsive">
                          <table id="ajax-crud-deadline-datatable" style="width: 1474px;">
                              <thead>
                                  <tr>
                                      <th scope="col">Batas Deadline Pembayaran</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Deadline</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="/agen/proses_save_deadline" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" name="days" type="number" required><br>
                            </div>
                        </div>                                            
                    </div>
