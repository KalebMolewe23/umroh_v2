...
?>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/agen/proses_update_profile/'.$id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <input type="hidden" name="id" value="<?= $id; ?>">
                        <strong>Nama</strong>
                        <input class="form-control" name="name" type="text" placeholder="Masukkan Nama Anda" value="<?= $profile->name ?>" required><br>
                        <strong>Email</strong>
                        <input class="form-control" name="email" type="text" placeholder="Masukkan Email Anda" value="<?= $profile->email ?>" required><br>
                        <strong>Masukkan Password Baru</strong>
                        <input class="form-control" name="password" type="password" placeholder="Masukkan Password Anda" required><br>
                        <div align="right">
